---
title: "QUT HPC Manual for DOHWA"
author:
...
Note that the leading `n9401849@Lyra01:~>` in the console is often called the *shell prompt*. It typically displays information about the current user and the host name of the machine. This is where you will type your code.
...
This indicates that you are now inside a "node" of the HPC that will automatically exit (aka shutdown) after 1 hour. Notice how the prefix to the `~>` symbol has changed from `n9401849@Lyra01:` (the head node) to `n9401849@cl4n007:` (the job). 
