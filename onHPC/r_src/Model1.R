...
# Save mod object					   
saveRDS(mod, file = paste0(base_folder, "/outputs/", cur_date, "/r/", Rfile, "_mod.rds"))
...
saveRDS(mf_cv_ll, file = paste0(base_folder, "/outputs/", cur_date, "/r/", Rfile, "_convergence.rds"))
